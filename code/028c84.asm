...
028d3c    60           rts
028d3d    20698d       jsr $028d69
028d40    a2ffff       ldx #$ffff
028d43    60           rts
028d44    20698d       jsr $028d69
...
028e40    60           rts
028e41    20d283       jsr $0283d2
028e44    205184       jsr $028451
028e47    20b185       jsr $0285b1
028e4a    20168c       jsr $028c16
028e4d    203386       jsr $028633
028e50    20e685       jsr $0285e6
028e53    204686       jsr $028646
028e56    20a085       jsr $0285a0
028e59    202086       jsr $028620
028e5c    201d8a       jsr $028a1d
028e5f    22d78802     jsl $0288d7
028e63    200285       jsr $028502
028e66    20298c       jsr $028c29
028e69    e220         sep #$20
028e6b    a901         lda #$01
028e6d    8545         sta $45
028e6f    a97e         lda #$7e
...
028ecd    2200800d     jsl $0d8000
028ed1    c220         rep #$20
028ed3    a900c4       lda #$c400
028ed6    22388700     jsl $008738
028eda    6b           rtl
028edb    e220         sep #$20
028edd    a545         lda $45
028edf    6445         stz $45
