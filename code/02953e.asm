...
02962e    60           rts
02962f    207ac9       jsr $02c97a
029632    2021ea       jsr $02ea21
...
029651    60           rts
029652    207ac9       jsr $02c97a
029655    2032ea       jsr $02ea32
029658    60           rts
029659    22cb9e00     jsl $009ecb
02965d    207ac9       jsr $02c97a
029660    2021ea       jsr $02ea21
029663    c220         rep #$20
029665    60           rts
029666    207ac9       jsr $02c97a
029669    c220         rep #$20
02966b    a90f84       lda #$840f
02966e    22388700     jsl $008738
029672    ee7610       inc $1076
029675    60           rts
029676    207ac9       jsr $02c97a
029679    e220         sep #$20
02967b    a562         lda $62
...
0296bc    ab           plb
0296bd    60           rts
0296be    20d283       jsr $0283d2
0296c1    205184       jsr $028451
0296c4    20ed98       jsr $0298ed
0296c7    201a99       jsr $02991a
0296ca    203386       jsr $028633
0296cd    20ee99       jsr $0299ee
0296d0    202086       jsr $028620
0296d3    200f9a       jsr $029a0f
0296d6    22d78802     jsl $0288d7
0296da    20389a       jsr $029a38
0296dd    c220         rep #$20
