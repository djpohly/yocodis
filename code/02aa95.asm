...
02aac4    60           rts
02aac5    20c1ab       jsr $02abc1
02aac8    2059ae       jsr $02ae59
02aacb    60           rts
02aacc    2092b3       jsr $02b392
02aacf    2033b3       jsr $02b333
02aad2    b008         bcs $02aadc
02aad4    20e8ab       jsr $02abe8
02aad7    b003         bcs $02aadc
02aad9    20a0ac       jsr $02aca0
02aadc    2059ae       jsr $02ae59
02aadf    60           rts
02aae0    20c1ab       jsr $02abc1
02aae3    201faf       jsr $02af1f
02aae6    60           rts
02aae7    2033b3       jsr $02b333
02aaea    b008         bcs $02aaf4
02aaec    2043ac       jsr $02ac43
02aaef    b003         bcs $02aaf4
02aaf1    20b8ad       jsr $02adb8
02aaf4    201faf       jsr $02af1f
02aaf7    60           rts
02aaf8    20c1ab       jsr $02abc1
02aafb    60           rts
02aafc    2033b3       jsr $02b333
02aaff    60           rts
02ab00    60           rts
02ab01    60           rts
02ab02    e220         sep #$20
...
02aba5    2059ae       jsr $02ae59
02aba8    8005         bra $02abaf
02abaa    201faf       jsr $02af1f
...
02ac81    20f987       jsr $0287f9
02ac84    e220         sep #$20
02ac86    a900         lda #$00
02ac88    eb           swa
02ac89    ad0002       lda $0200
02ac8c    20f987       jsr $0287f9
02ac8f    c220         rep #$20
