...
02eb0c    227b8e00     jsl $008e7b
02eb10    eea810       inc $10a8
02eb13    60           rts
02eb14    2021ea       jsr $02ea21
02eb17    60           rts
...
02eb60    850c         sta $0c
02eb62    229d8700     jsl $00879d
02eb66    60           rts
02eb67    20faf0       jsr $02f0fa
02eb6a    20e7c5       jsr $02c5e7
02eb6d    202086       jsr $028620
02eb70    2053c6       jsr $02c653
02eb73    2091c6       jsr $02c691
02eb76    c220         rep #$20
02eb78    adfc10       lda $10fc
02eb7b    2017f0       jsr $02f017
02eb7e    a21009       ldx #$0910
02eb81    8eac11       stx $11ac
02eb84    22c2f302     jsl $02f3c2
02eb88    2084f3       jsr $02f384
02eb8b    228f8600     jsl $00868f
02eb8f    e220         sep #$20
02eb91    a22ecf       ldx #$cf2e
02eb94    8ec400       stx $00c4
02eb97    a903         lda #$03
02eb99    8dc600       sta $00c6
02eb9c    22239000     jsl $009023
02eba0    223c9100     jsl $00913c
02eba4    a97e         lda #$7e
02eba6    48           pha
02eba7    f40080       pea $8000
02ebaa    f40050       pea $5000
02ebad    f40020       pea $2000
02ebb0    222a8902     jsl $02892a
02ebb4    e220         sep #$20
02ebb6    a246ee       ldx #$ee46
02ebb9    8ec400       stx $00c4
02ebbc    a903         lda #$03
02ebbe    8dc600       sta $00c6
02ebc1    22239000     jsl $009023
02ebc5    223c9100     jsl $00913c
02ebc9    a97e         lda #$7e
02ebcb    48           pha
02ebcc    f40080       pea $8000
02ebcf    f40060       pea $6000
02ebd2    f4000b       pea $0b00
02ebd5    222a8902     jsl $02892a
02ebd9    e220         sep #$20
02ebdb    a240d9       ldx #$d940
02ebde    8ec400       stx $00c4
02ebe1    a903         lda #$03
02ebe3    8dc600       sta $00c6
02ebe6    22239000     jsl $009023
02ebea    223c9100     jsl $00913c
02ebee    a97e         lda #$7e
02ebf0    48           pha
02ebf1    f40080       pea $8000
02ebf4    f40000       pea $0000
02ebf7    f40010       pea $1000
02ebfa    222a8902     jsl $02892a
02ebfe    c220         rep #$20
...
02ec1b    2054ef       jsr $02ef54
02ec1e    206fef       jsr $02ef6f
...
02ec32    2200800d     jsl $0d8000
02ec36    a90100       lda #$0001
02ec39    22798c00     jsl $008c79
02ec3d    e220         sep #$20
02ec3f    6445         stz $45
02ec41    a90f         lda #$0f
02ec43    8561         sta $61
