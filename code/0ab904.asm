...
0ab92d    eb           swa
0ab92e    a901         lda #$01
0ab930    22448700     jsl $008744
0ab934    a980         lda #$80
0ab936    04c3         tsb $c3
0ab938    e647         inc $47
0ab93a    60           rts
0ab93b    229d9a0a     jsl $0a9a9d
0ab93f    e220         sep #$20
0ab941    a564         lda $64
0ab943    29f0         and #$f0
0ab945    c9e0         cmp #$e0
0ab947    b004         bcs $0ab94d
0ab949    20cac8       jsr $0ac8ca
0ab94c    60           rts
0ab94d    20dbc8       jsr $0ac8db
0ab950    a565         lda $65
0ab952    4940         eor #$40
0ab954    8565         sta $65
0ab956    e647         inc $47
0ab958    60           rts
0ab959    229d9a0a     jsl $0a9a9d
...
0ab96e    20efc8       jsr $0ac8ef
0ab971    a20000       ldx #$0000
0ab974    2051cb       jsr $0acb51
0ab977    a20001       ldx #$0100
0ab97a    2051cb       jsr $0acb51
0ab97d    201fce       jsr $0ace1f
0ab980    202fb8       jsr $0ab82f
0ab983    eb           swa
0ab984    c5e6         cmp $e6
0ab986    f008         beq $0ab990
0ab988    eb           swa
0ab989    2041b8       jsr $0ab841
0ab98c    2200800d     jsl $0d8000
...
0ab9c7    20f0cb       jsr $0acbf0
0ab9ca    9c0005       stz $0500
0ab9cd    20f0cb       jsr $0acbf0
...
0aba05    20efc8       jsr $0ac8ef
0aba08    a9b600       lda #$00b6
0aba0b    855c         sta $5c
0aba0d    e220         sep #$20
0aba0f    e647         inc $47
0aba11    60           rts
0aba12    2065c8       jsr $0ac865
0aba15    a55c         lda $5c
...
0aba2a    200bcc       jsr $0acc0b
0aba2d    a20000       ldx #$0000
0aba30    200bcc       jsr $0acc0b
0aba33    a90000       lda #$0000
0aba36    20efc8       jsr $0ac8ef
0aba39    e220         sep #$20
0aba3b    e647         inc $47
0aba3d    60           rts
0aba3e    a92c01       lda #$012c
0aba41    8d640a       sta $0a64
0aba44    224d800a     jsl $0a804d
0aba48    20e9ce       jsr $0acee9
...
0aba87    64c3         stz $c3
0aba89    c220         rep #$20
0aba8b    20e9ce       jsr $0acee9
0aba8e    2263bc0a     jsl $0abc63
0aba92    203ecf       jsr $0acf3e
0aba95    2075d2       jsr $0ad275
0aba98    225a8a0a     jsl $0a8a5a
0aba9c    224d800a     jsl $0a804d
0abaa0    60           rts
...
0abab0    8547         sta $47
0abab2    60           rts
0abab3    20e3d4       jsr $0ad4e3
0abab6    224d800a     jsl $0a804d
0ababa    202fb8       jsr $0ab82f
0ababd    eb           swa
0ababe    c5e6         cmp $e6
0abac0    f008         beq $0abaca
0abac2    eb           swa
0abac3    2041b8       jsr $0ab841
0abac6    2200800d     jsl $0d8000
...
0abb08    22fb810d     jsl $0d81fb
0abb0c    203fc8       jsr $0ac83f
...
0abb27    20daca       jsr $0acada
0abb2a    200ccb       jsr $0acb0c
0abb2d    8a           txa
...
0abb45    224d800a     jsl $0a804d
0abb49    e220         sep #$20
0abb4b    e647         inc $47
0abb4d    60           rts
0abb4e    224d800a     jsl $0a804d
0abb52    ad2401       lda $0124
0abb55    d021         bne $0abb78
0abb57    20bcca       jsr $0acabc
0abb5a    200ccb       jsr $0acb0c
0abb5d    8a           txa
0abb5e    3006         bmi $0abb66
0abb60    a90200       lda #$0002
0abb63    9d2409       sta $0924,x
0abb66    200ccb       jsr $0acb0c
0abb69    9b           txy
...
0abb76    e647         inc $47
0abb78    60           rts
0abb79    224d800a     jsl $0a804d
0abb7d    a55c         lda $5c
0abb7f    d004         bne $0abb85
0abb81    e220         sep #$20
0abb83    e647         inc $47
0abb85    60           rts
0abb86    224d800a     jsl $0a804d
0abb8a    e220         sep #$20
0abb8c    a903         lda #$03
...
0abb9f    eb           swa
0abba0    a90f         lda #$0f
0abba2    22388700     jsl $008738
0abba6    e647         inc $47
0abba8    60           rts
0abba9    224d800a     jsl $0a804d
0abbad    e220         sep #$20
0abbaf    a562         lda $62
...
0abbf8    20efc8       jsr $0ac8ef
0abbfb    a90400       lda #$0004
0abbfe    855c         sta $5c
0abc00    a98100       lda #$0081
0abc03    22fb810d     jsl $0d81fb
0abc07    e220         sep #$20
0abc09    a91a         lda #$1a
0abc0b    2230820d     jsl $0d8230
0abc0f    e647         inc $47
0abc11    60           rts
...
0abc34    20efc8       jsr $0ac8ef
0abc37    a98200       lda #$0082
0abc3a    22fb810d     jsl $0d81fb
