...
0ae675    22798c00     jsl $008c79
0ae679    a9f0b4       lda #$b4f0
0ae67c    85c4         sta $c4
0ae67e    a90600       lda #$0006
0ae681    85c6         sta $c6
0ae683    22239000     jsl $009023
0ae687    223c9100     jsl $00913c
0ae68b    a988e8       lda #$e888
0ae68e    8500         sta $00
0ae690    a90a00       lda #$000a
0ae693    8502         sta $02
0ae695    22c68900     jsl $0089c6
0ae699    228f8600     jsl $00868f
0ae69d    a9f2d8       lda #$d8f2
0ae6a0    85c4         sta $c4
0ae6a2    a90600       lda #$0006
0ae6a5    85c6         sta $c6
0ae6a7    22239000     jsl $009023
0ae6ab    223c9100     jsl $00913c
0ae6af    a990e8       lda #$e890
0ae6b2    8500         sta $00
0ae6b4    a90a00       lda #$000a
0ae6b7    8502         sta $02
0ae6b9    22c68900     jsl $0089c6
0ae6bd    228f8600     jsl $00868f
0ae6c1    a00000       ldy #$0000
0ae6c4    22f59a00     jsl $009af5
0ae6c8    2021d9       jsr $0ad921
0ae6cb    2042f0       jsr $0af042
0ae6ce    2055f0       jsr $0af055
0ae6d1    a94f20       lda #$204f
0ae6d4    a20060       ldx #$6000
0ae6d7    a00010       ldy #$1000
0ae6da    22688b00     jsl $008b68
0ae6de    a998e8       lda #$e898
0ae6e1    8500         sta $00
0ae6e3    a90a00       lda #$000a
0ae6e6    8502         sta $02
0ae6e8    22c68900     jsl $0089c6
0ae6ec    a9a0e8       lda #$e8a0
0ae6ef    8500         sta $00
0ae6f1    a90a00       lda #$000a
0ae6f4    8502         sta $02
0ae6f6    22c68900     jsl $0089c6
0ae6fa    a9a8e8       lda #$e8a8
0ae6fd    8500         sta $00
0ae6ff    a90a00       lda #$000a
0ae702    8502         sta $02
0ae704    22c68900     jsl $0089c6
...
0ae71c    228f8600     jsl $00868f
0ae720    20e2fb       jsr $0afbe2
0ae723    a90201       lda #$0102
0ae726    2200800d     jsl $0d8000
...
0ae73f    eb           swa
0ae740    a900         lda #$00
0ae742    22388700     jsl $008738
0ae746    6468         stz $68
0ae748    6b           rtl
0ae749    a90000       lda #$0000
0ae74c    22798c00     jsl $008c79
0ae750    2008a4       jsr $0aa408
0ae753    200ff7       jsr $0af70f
0ae756    22ca940a     jsl $0a94ca
...
0ae76c    85c6         sta $c6
0ae76e    22239000     jsl $009023
0ae772    223c9100     jsl $00913c
0ae776    a988e8       lda #$e888
0ae779    8500         sta $00
0ae77b    a90a00       lda #$000a
0ae77e    8502         sta $02
0ae780    22c68900     jsl $0089c6
0ae784    228f8600     jsl $00868f
0ae788    a970e5       lda #$e570
0ae78b    85c4         sta $c4
0ae78d    a90800       lda #$0008
0ae790    85c6         sta $c6
0ae792    22239000     jsl $009023
0ae796    223c9100     jsl $00913c
0ae79a    a990e8       lda #$e890
0ae79d    8500         sta $00
0ae79f    a90a00       lda #$000a
0ae7a2    8502         sta $02
0ae7a4    22c68900     jsl $0089c6
0ae7a8    228f8600     jsl $00868f
0ae7ac    a00000       ldy #$0000
0ae7af    22c49a00     jsl $009ac4
0ae7b3    2021d9       jsr $0ad921
0ae7b6    8b           phb
...
0ae83c    2045f6       jsr $0af645
0ae83f    20b8c3       jsr $0ac3b8
0ae842    2061f8       jsr $0af861
0ae845    207bf6       jsr $0af67b
0ae848    228f8600     jsl $00868f
