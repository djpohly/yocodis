...
0aeb5b    2005f5       jsr $f505
0aeb5e    9c2409       stz $0924
0aeb61    2045f6       jsr $f645
0aeb64    20b8c3       jsr $c3b8
0aeb67    207bf6       jsr $f67b
0aeb6a    20b0e8       jsr $e8b0
0aeb6d    eb           swa
0aeb6e    c5e6         cmp $e6
...
0aebb2    2005f5       jsr $f505
0aebb5    a90300       lda #$0003
0aebb8    2005f5       jsr $f505
0aebbb    e220         sep #$20
0aebbd    e647         inc $47
0aebbf    60           rts
...
0aebea    2005f5       jsr $f505
0aebed    e220         sep #$20
0aebef    e647         inc $47
0aebf1    60           rts
0aebf2    a91000       lda #$0010
0aebf5    8d4808       sta $0848
0aebf8    2043f5       jsr $f543
0aebfb    e220         sep #$20
0aebfd    e647         inc $47
0aebff    60           rts
