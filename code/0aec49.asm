...
0aeca9    202eb6       jsr $0ab62e
0aecac    a0e001       ldy #$01e0
0aecaf    202eb6       jsr $0ab62e
0aecb2    224d800a     jsl $0a804d
0aecb6    a55c         lda $5c
0aecb8    d022         bne $0aecdc
0aecba    a90400       lda #$0004
0aecbd    2005f5       jsr $0af505
...
0aeced    e647         inc $47
0aecef    60           rts
0aecf0    224d800a     jsl $0a804d
0aecf4    4c62e9       jmp $0ae962
0aecf7    224d800a     jsl $0a804d
0aecfb    a90000       lda #$0000
0aecfe    2005f5       jsr $0af505
0aed01    a90b00       lda #$000b
0aed04    2005f5       jsr $0af505
0aed07    a90900       lda #$0009
0aed0a    2005f5       jsr $0af505
0aed0d    a99003       lda #$0390
0aed10    8dac11       sta $11ac
0aed13    22c2f302     jsl $02f3c2
0aed17    e220         sep #$20
...
0aed3d    8506         sta $06
0aed3f    a5bb         lda $bb
0aed41    22629700     jsl $009762
0aed45    900a         bcc $0aed51
0aed47    8d0002       sta $0200
0aed4a    a90700       lda #$0007
0aed4d    2230820d     jsl $0d8230
0aed51    20cbf9       jsr $0af9cb
0aed54    224d800a     jsl $0a804d
0aed58    60           rts
0aed59    e220         sep #$20
...
0aed68    eb           swa
0aed69    a90f         lda #$0f
0aed6b    22388700     jsl $008738
0aed6f    e647         inc $47
0aed71    e647         inc $47
0aed73    20cbf9       jsr $0af9cb
0aed76    224d800a     jsl $0a804d
0aed7a    60           rts
0aed7b    20cbf9       jsr $0af9cb
0aed7e    a55c         lda $5c
0aed80    d016         bne $0aed98
0aed82    2008a4       jsr $0aa408
...
0aed96    8547         sta $47
0aed98    60           rts
0aed99    20cbf9       jsr $0af9cb
0aed9c    224d800a     jsl $0a804d
0aeda0    e220         sep #$20
0aeda2    a562         lda $62
0aeda4    d006         bne $0aedac
0aeda6    a993         lda #$93
0aeda8    22758b00     jsl $008b75
0aedac    60           rts
0aedad    a90600       lda #$0006
0aedb0    2005f5       jsr $0af505
0aedb3    a90400       lda #$0004
0aedb6    855c         sta $5c
0aedb8    e220         sep #$20
0aedba    a91a         lda #$1a
0aedbc    2230820d     jsl $0d8230
0aedc0    e647         inc $47
0aedc2    60           rts
...
0aedeb    e220         sep #$20
0aeded    a982         lda #$82
0aedef    22fb810d     jsl $0d81fb
0aedf3    a90a         lda #$0a
0aedf5    8547         sta $47
0aedf7    60           rts
0aedf8    224d800a     jsl $0a804d
0aedfc    a55c         lda $5c
...
0aee11    20e4f4       jsr $0af4e4
0aee14    220d9a0a     jsl $0a9a0d
0aee18    e220         sep #$20
0aee1a    a90a         lda #$0a
0aee1c    8547         sta $47
0aee1e    224d800a     jsl $0a804d
0aee22    60           rts
0aee23    a55c         lda $5c
0aee25    d027         bne $0aee4e
0aee27    a90500       lda #$0005
0aee2a    2005f5       jsr $0af505
...
0aee59    2005f5       jsr $0af505
0aee5c    e220         sep #$20
0aee5e    e647         inc $47
0aee60    60           rts
0aee61    ad1401       lda $0114
0aee64    d007         bne $0aee6d
0aee66    200ff9       jsr $0af90f
0aee69    e220         sep #$20
0aee6b    e647         inc $47
0aee6d    60           rts
0aee6e    201af9       jsr $0af91a
...
0aee97    e636         inc $36
0aee99    2094f9       jsr $0af994
0aee9c    20b5f4       jsr $0af4b5
0aee9f    2045f6       jsr $0af645
0aeea2    e220         sep #$20
0aeea4    e647         inc $47
0aeea6    60           rts
...
0aeed4    2005f5       jsr $0af505
0aeed7    a90900       lda #$0009
0aeeda    2005f5       jsr $0af505
0aeedd    e220         sep #$20
0aeedf    e647         inc $47
0aeee1    60           rts
...
0aef33    eb           swa
0aef34    a90f         lda #$0f
0aef36    22388700     jsl $008738
0aef3a    e647         inc $47
0aef3c    60           rts
0aef3d    e220         sep #$20
0aef3f    a98a         lda #$8a
0aef41    22758b00     jsl $008b75
0aef45    60           rts
0aef46    08           php
0aef47    c220         rep #$20
0aef49    220d9a0a     jsl $0a9a0d
